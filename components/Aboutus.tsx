...
export const Aboutus = () => {
    ...
    return <div className="flex justify-center pt-15 md:pt-20" id="about">
        <div>
            ...
            <div className="">
                <div className="w-[100px] md:w-[300px] flex justify-center pt-9 md:pt-15 bg-[#FFFFFF] mx-auto md:mx-0 items-center"> <HTMLContent/> <p className="text-[42px] md:text-7xl">%</p> </div>
                ...
                <div className="">
                <div className="w-[100px] md:w-[300px] flex justify-center pt-9 md:pt-15 bg-[#FFFFFF] mx-auto md:mx-0 items-center"> <HTMLContent2/><p className="text-[42px] md:text-7xl">K</p> </div>
                <div className="flex justify-center text-lg md:text-2xl text-start px-auto font-semibold">
                ...
                <div className="">
                <div className="w-[100px] md:w-[300px] flex justify-center pt-9 md:pt-15 bg-[#FFFFFF] mx-auto md:mx-0 items-center"> <HTMLContent3/> <p className="text-[42px] md:text-7xl">DAY</p> </div>
                <div className="flex justify-center text-lg md:text-2xl text-start px-auto font-semibold">
