            ...
            <div className="flex flex-col md:flex-row justify-between px-7 md:px-0 pt-10 md:pt-30">
              ...
              <div className="flex justify-center my-auto">
                <div className="pt-7 md:pt-0 max-w-2xl">
                  ...
                  <div className="pt-5"><a href="tel:8264551555" className="mx-auto md:mx-0 flex mt-3 justify-center text-white hover:bg-[#FAB855] transition duration-300 text-base md:text-base font-medium w-[200px] md:w-[400px] py-3 md:py-5 rounded-lg bg-black">Apply Know</a></div>
                </div>
              </div>
            </div> 
