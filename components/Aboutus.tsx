...
export const Aboutus = () => {
    ...
    return <div className="flex justify-center pt-15 md:pt-20" id="about">
        <div>
            ...
            <div className="">
                <div className="w-[100px] md:w-[300px] flex justify-center pt-9 md:pt-15 bg-[#FFFFFF] mx-auto md:mx-0 items-center"> <HTMLContent/> <p className="text-[42px] md:text-7xl pb-2">%</p> </div>
                ...
                <div className="">
                <div className="w-[100px] md:w-[300px] flex justify-center pt-9 md:pt-15 bg-[#FFFFFF] mx-auto md:mx-0 items-center"> <HTMLContent2/><p className="text-[42px] md:text-7xl pb-2">K</p> </div>
                <div className="flex justify-center text-lg md:text-2xl text-start px-auto font-semibold">
                ...
                <div className="">
                <div className="w-[100px] md:w-[300px] flex justify-center pt-9 md:pt-15 bg-[#FFFFFF] mx-auto md:mx-0 items-center"> <HTMLContent3/> <p className="text-[42px] md:text-7xl pb-2">DAY</p> </div>
                <div className="flex justify-center text-lg md:text-2xl text-start px-auto font-semibold">
            ...
            <div className="flex flex-col md:flex-row justify-between px-7 md:px-0 pt-10 md:pt-30">
              ...
              <div className="flex justify-center my-auto">
                <div className="pt-7 md:pt-0 max-w-2xl">
                  ...
                  <div className="pt-5"><a href="tel:9888386639" className="mx-auto md:mx-0 flex mt-3 justify-center text-white hover:bg-[#00CC99] transition duration-300 text-base md:text-base font-medium w-[200px] md:w-[400px] py-3 md:py-5 rounded-lg bg-[#0191FF]">Apply Know</a></div>
                </div>
              </div>
            </div> 
