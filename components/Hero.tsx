...
export const Hero = () => {
    ...
    return <div id="home" style={{backgroundImage: "url('/hero_bg5.png')"}} className="h-screen bg-cover bg-center">
        ...
        <div className="pt-14 space-x-5 font-sans">
            <a className="py-3 md:py-5 px-4 md:px-14 text-base md:text-base rounded-lg text-white font-medium bg-[#00CC99] hover:bg-[#0191FF] transition duration-400 " href="tel:9888386639">Book Appointment</a>
